...
export const es: TranslationTree = {
	...
	views: {
		...
		releaseNotes: {
			title: "Novedades de TaskNotes Time {version}",
			header: "Novedades de TaskNotes Time {version}",
	...
	settings: {
		...
		features: {
			...
			uiLanguage: {
				...
				description: "Cambiar el idioma de los menús, avisos y vistas de TaskNotes Time.",
				dropdown: {
					name: "Idioma de interfaz",
					description:
						"Seleccionar el idioma usado para el texto de la interfaz de TaskNotes Time",
				},
			},
			pomodoroSound: {
		...
		appearance: {
			themeColors: {
				...
				description:
					"Elige si TASKquence utiliza su propia paleta o sigue el tema de apariencia activo de Obsidian.",
				usePluginColors: {
					name: "Usar los colores del tema de TASKquence",
					description:
						"Conserva los colores actuales de TASKquence. Desactiva esta opción para heredar los fondos, textos, bordes, acentos, estados al pasar el cursor y colores semánticos de Obsidian en los tableros y el temporizador flotante.",
				},
			},
			taskCards: {
	...
	notices: {
		...
		releaseAvailable: {
			message: "TaskNotes Time {version} está disponible.",
	...
	commands: {
		...
		openStatisticsView: "Abrir estadísticas de tiempo",
		openGoalsView: "Abrir gestión de objetivos",
	...
	modals: {
		...
		taskCreation: {
			...
			actions: {
				...
				hideDetailedOptions: "Ocultar propiedades adicionales",
				showDetailedOptions: "Mostrar todas las propiedades",
			},
