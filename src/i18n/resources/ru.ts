	...
	settings: {
		...
		goals: {
			...
			folder: {
				name: "Папка целей",
				description:
					"Путь относительно корня хранилища для чтения и создания заметок целей. Оставьте пустым, чтобы использовать {defaultFolder}. Изменение настройки не перемещает существующие заметки. Переместите их в выбранную папку или укажите {legacyFolder}, чтобы использовать прежнее расположение.",
			},
		},
		features: {
			inlineTasks: {
		...
		appearance: {
			...
			taskCards: {
				...
				properties: {
					...
					checklistProgress: "Прогресс подзадач",
					recurrence: "Повторение",
					completedDate: "Дата завершения",
