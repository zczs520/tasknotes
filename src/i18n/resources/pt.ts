...
export const pt: TranslationTree = {
	...
	views: {
		...
		releaseNotes: {
			title: "O que há de novo no TaskNotes Time {version}",
			header: "O que há de novo no TaskNotes Time {version}",
	...
	settings: {
		...
		features: {
			...
			uiLanguage: {
				...
				description: "Altere o idioma dos menus, avisos e visualizações do TaskNotes Time.",
				dropdown: {
					name: "Idioma da UI",
					description: "Selecione o idioma usado para o texto da interface do TaskNotes Time",
				},
			},
			pomodoroSound: {
		...
		appearance: {
			themeColors: {
				...
				description:
					"Escolha se o TASKquence usa sua própria paleta ou segue o tema de aparência ativo do Obsidian.",
				usePluginColors: {
					name: "Usar as cores do tema do TASKquence",
					description:
						"Mantém as cores atuais do TASKquence. Desative esta opção para herdar os fundos, textos, bordas, realces, estados de foco do cursor e cores semânticas do Obsidian nos quadros e no temporizador flutuante.",
				},
			},
			taskCards: {
			...
			uiElements: {
				...
				showRelationshipsWidget: {
					name: "Subtarefas e relacionamentos",
					description: "Exibir subtarefas, projetos e dependências na nota",
				},
				showTimeEntriesInNote: {
					name: "Registros de tempo",
					description: "Exibir registros de tempo no final das notas de tarefas",
				},
	...
	notices: {
		...
		releaseAvailable: {
			message: "TaskNotes Time {version} está disponível.",
	...
	commands: {
		...
		openStatisticsView: "Abrir estatísticas de tempo",
		openGoalsView: "Abrir gestão de objetivos",
	...
	modals: {
		...
		taskCreation: {
			...
			actions: {
				...
				hideDetailedOptions: "Ocultar propriedades adicionais",
				showDetailedOptions: "Mostrar todas as propriedades",
			},
