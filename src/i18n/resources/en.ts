...
export const en: TranslationTree = {
	onboarding: {
		...
		// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
		viewDisabled: "Enable this view in settings → TaskNotes Time → general → views & base files.",
	},
	common: {
		// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
	...
	views: {
		...
		releaseNotes: {
			title: "What's new in TaskNotes Time {version}",
			header: "What's new in TaskNotes Time {version}",
		...
		basesViewSettings: {
			viewNames: {
					// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
					taskList: "TaskNotes Time task list",
					// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
					kanban: "TaskNotes Time Kanban",
					// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
					calendar: "TaskNotes Time calendar",
					// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
					miniCalendar: "TaskNotes Time mini calendar",
					// eslint-disable-next-line obsidianmd/ui/sentence-case-locale-module -- Official product capitalization.
		...
		appearance: {
			...
			taskCards: {
				...
				properties: {
					...
					checklistProgress: "Subtask progress",
					recurrence: "Recurrence",
					completedDate: "Completed date",
			...
			uiElements: {
				...
				showRelationshipsWidget: {
					name: "Subtasks & relationships",
					description:
						"Show subtasks, projects, and dependencies in the note",
				},
				showTimeEntriesInNote: {
					name: "Time entries",
					description: "Show time entries at the bottom of task notes",
				},
	...
	goals: {
		view: {
			...
			historyReadonly: "Historical view · read only",
			columns: {
				goal: "Goal",
				type: "Type",
				today: "Today",
			...
			childCountOne: "{count} child goal",
			childCountOther: "{count} child goals",
			ownedByChildren: "Owned by child goals",
			openGoal: "Open goal {name}",
			countActual: "{actual} times",
			countProgress: "{actual} / {target} times",
			milestones: "Milestones",
			milestoneSubtitle:
				"Cumulative · unchanged by the time range above, including previous weeks",
			milestoneSummary: "{count} total · {complete} achieved",
			milestoneSummaryStale: "{count} total · {complete} achieved · {stale} awaiting update",
			noMilestones: "No milestones yet. Add an outcome or completion item in goal details.",
		},
		management: "Goal management",
		newGoal: "New goal",
		refresh: "Refresh",
		paused: "Paused",
		emptyTitle: "Give your tasks a destination",
		emptyDescription: "Tracked time is ready to be connected to a goal.",
		createGoal: "Create goal",
		cancel: "Cancel",
		name: "Name",
		type: "Type",
		floor: "Minimum investment",
		ceiling: "Maximum investment",
		count: "Frequency",
		floorHint: "More is better",
		ceilingHint: "Warn when exceeded",
		countHint: "Count sessions",
		scope: "Included tags",
		addTag: "Filter or add a tag…",
		baseline: "4-week baseline",
		split: "Create one child goal per tag",
		period: "Period",
		weekly: "Week",
		monthly: "Month",
		quarterly: "Quarter",
		...
		milestoneName: "Outcome name",
		tiers: "Tiers, e.g. 100, 1000, 5000",
		files: "Goal files",
		...
		confirmAchievementDescription: "Today and the invested hours will be recorded.",
		continue: "Continue",
		undo: "Undo achievement",
		openFile: "Open goal note",
		notDesktop: "Goal management is available on desktop only.",
	},
	notices: {
		languageChanged: "Language changed to {language}.",
		releaseAvailable: {
			message: "TaskNotes Time {version} is available.",
	...
	commands: {
		...
		openGoalsView: "Open goal management",
		openGoalBoard: "Open goal board",
