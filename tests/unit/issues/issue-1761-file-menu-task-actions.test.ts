...
describe("issue #1761 - native file menu TaskNotes Time actions", () => {
	beforeEach(() => {
		jest.clearAllMocks();
	});

	it("adds edit and TaskNotes Time submenu entries for recognized task files", async () => {
		...
		expect(taskNotesItem.setTitle).toHaveBeenCalledWith("TaskNotes Time");
